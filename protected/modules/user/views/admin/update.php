...
<hr/>
<?php
	echo $this->renderPartial('_form', array('model'=>$model,'profile'=>$profile,'statusPage'=>'update'));
?>
</div>
</div>
...
<?php  ?>	
    ...
    <?php echo TbHtml::navList(array(
        ...
        array('label' => 'View Users', 'url' => array('/user/admin/view','id'=>$model->id)),
        array('label' => 'Update Users', 'url' => array('/user/admin/update','id'=>$model->id), 'active' => true),
