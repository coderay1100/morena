				 ...
				 for ($i=2; $i<=$baris; $i++)
					{
					 ...
					 $command->insert('listgaji', array(
										...
										'transport'=>$rowData[8],
										'pulse'=>$rowData[9],
										'medicalAllowance'=>$rowData[10],
										'overtime'=>$rowData[11],
						 				'bonus'=>$rowData[12],
										'thr'=>$rowData[13],
										'correctionPlus'=>$rowData[14],
										'incentive'=>$rowData[15],
										'jobAllowance'=>$rowData[16],
										'marriageAllowance'=>$rowData[17],
										'houseAllowance'=>$rowData[18],
										'taskForceAllowance'=>$rowData[19],
										'maternityAllowance'=>$rowData[20],
										'glassesAllowance'=>$rowData[21],
										'condolanceAllowance'=>$rowData[22],
										'separationPay'=>$rowData[23],
										'opex'=>$rowData[24],
										'coc'=>$rowData[25],
										'pph21'=>$rowData[26],
						 				'bpjs'=>$rowData[27],
						 				'jamsostek'=>$rowData[28],
										'benefitMin'=>$rowData[29],
										'copAllowanceMin'=>$rowData[30],
										'loan'=>$rowData[31],
										'state'=>'Y',
